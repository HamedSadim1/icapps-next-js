...
const StagairFormAction = ({ params: { id } }: Params) => {
  const [data, setData] = useState<IStagaire>({} as IStagaire);
  ...
  const formFormatDate = (date: string | null): string => {
    if (!date) {
      return "";
    }
        ...
        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              type="date"
              name="startDate"
              value={formFormatDate(data.startDate)}
          ...
          <div>
            ...
            <input
              ...
              type="date"
              name="endDate"
              value={formFormatDate(data.endDate)}
          ...
          <div>
            ...
            >
              <option value="default" disabled>
                Select stagebegeleiders
              </option>
              {data.stagebegeleiderId.map((stagebegeleider) => (
                <option key={stagebegeleider} value={stagebegeleider}>
                  {stagebegeleider}
                </option>
              ))}
            </select>
...
export default StagairFormAction;
