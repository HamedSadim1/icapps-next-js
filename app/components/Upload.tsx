          ...
          <div className="bg-white shadow-xl w-1/3 h-auto pb-7 text-gray-500 z-2 rounded-md">
            ...
            <div className="flex pt-16 mx-16">
              ...
              >
                ...
                {docText != "Bestand kiezen" ? (
                  <AiOutlineDownload className="float-right text-3xl mx-auto bg-gray-100 top-0 right-0"></AiOutlineDownload>
                ) : (
                  <AiOutlineUpload className="float-right text-3xl mx-auto bg-gray-100 top-0 right-0"></AiOutlineUpload>
                )}
              </label>
              <input
            ...
            {docText != "Bestand kiezen" && (
              <p className="bg-gray-100 mx-16 px-3 pb-3">
                {date.getDate()}/{date.getMonth()}/{date.getFullYear()} door
                Steve Jobs
              </p>
            )}
            <div className="mx-6 pt-5">
              ...
              <button className="bg-white text-gray-500 hover:text-gray-900 border-none pl-1 ml-10 mt-2">
