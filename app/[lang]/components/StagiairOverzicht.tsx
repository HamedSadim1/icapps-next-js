  ...
  return (
    <section className="container mx-auto p-4">
      <AuthorizedRole
        ...
        userRole={role}
      >
        <SearchStagiair search={searchStagiair} setSearch={setsearchStagiair} lang={lang} />
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border border-gray-200 mt-12">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-6 py-3 text-left">{translation.userStagiair['name']}</th>
                <th className="px-6 py-3 text-left">{translation.userStagiair['e-mail']}</th>
                <th className="px-6 py-3 text-left">{translation.userStagiair['startingdate']}</th>
                <th className="px-6 py-3 text-left">{translation.userStagiair['endingdata']}</th>
                <th className="px-6 py-3 text-left">{translation.userStagiair['internshipsupervisors']}</th>
              ...
              {filteredStagiair?.map((stagiair) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    ...
                    <span>
                      <StagairForm params={{ id: stagiair.id, lang: lang }} />
                    </span>
                  </td>
                </tr>
              ))}
